...
namespace UnityFaceIDHelper
{
    ...
    {
        RSP_200_SUCCESS_GENERAL = 0,
        RSP_202_SUCCESS_TRAINING = 1,

        RSP_400_FAIL_ARGUMENT = 2,
        RSP_401_FAIL_SUBKEY = 3,
        RSP_403_FAIL_QUOTA = 4,
        RSP_404_FAIL_NOTFOUND = 5,
        RSP_408_FAIL_TIMEOUT = 6,
        RSP_409_FAIL_RESOURCECONFLICT = 7,
        RSP_415_FAIL_UNSUPPORTEDMEDIA = 8,
        RSP_429_FAIL_RATELIMIT = 9
    }
}
